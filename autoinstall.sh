...
sudo transactional-update -i pkg in quickshell gpu-screen-recorder-gtk cava ddcutil cliphist wlsunset swaylock swayidle sway-contrib xdg-desktop-portal-wlr evolution-data-server polkit-kde-agent-6
